...
//    }
//
//    public static void get_adsTrack(Context context, String game_id, String union_id, String action) {
...
//        IntlGameLogUtil.i(TAG, "domain:" + game_id);
//        IntlGameLogUtil.i(TAG, "udid:" + LemonGame.UUID);
//        IntlGameLogUtil.i(TAG, "SDKVersion:Android2.0.2");
//        IntlGameLogUtil.i(TAG, "clientVersion:" + LemonGame.ClientVersion);
//        IntlGameLogUtil.i(TAG, "union_id:" + union_id);
//        IntlGameLogUtil.i(TAG, "action:" + action);
//        IntlGameLogUtil.i(TAG, LemonGame.ADS_CONFIGURATION);
//        LemonGame.asyncRequestWithoutTicket(LemonGame.ADS_CONFIGURATION, bundle, "POST", new IRequestWithoutTicketListener() {
//            public void onComplete(String response) {
//                IntlGameLogUtil.i(IntlGameAdStrack.TAG, "非init广告请求：" + response);
//            }
//
